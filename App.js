...
import OtpSafetyLessonScreen from './src/screens/OtpSafetyLessonScreen';
  ...
  return (
    <Stack.Navigator
      ...
      screenOptions={{
        ...
        headerTitleStyle: { fontFamily: theme.typography.fontFamily.semibold, fontSize: 18 },
      }}
    >
      <Stack.Screen
        name="Home"
      ...
      <Stack.Screen
        name="OtpSafetyLesson"
        component={OtpSafetyLessonScreen}
        options={{
          title: 'OTP सुरक्षित रखें',
          headerBackTitle: 'वापस',
        }}
      />

      <Stack.Screen
        name="FakeLinkSafetyLesson"
        component={OtpSafetyLessonScreen}
        initialParams={{ lessonKey: 'fakeLink' }}
        options={{
          title: 'नकली लिंक पहचानें',
          headerBackTitle: 'वापस',
        }}
      />
