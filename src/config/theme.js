...
export const COLORS = {
  ...
  // UI semantic roles keep color and contrast consistent across screens.
  ui: {
    onPrimary: '#2C2420',
    onDark: '#FFFFFF',
    cardBorder: '#E8E6E3',
    successSurface: '#EAF8EE',
    warningSurface: '#FFF0DF',
    infoSurface: '#EAF9F5',
    focusBorder: '#6C3483',
  },
...
export const theme = {
  colors: {
    ...
    header: COLORS.primary[800],
    headerForeground: COLORS.neutral.white,
    onPrimary: COLORS.ui.onPrimary,
    onDark: COLORS.ui.onDark,
    successSurface: COLORS.ui.successSurface,
    warningSurface: COLORS.ui.warningSurface,
    infoSurface: COLORS.ui.infoSurface,
