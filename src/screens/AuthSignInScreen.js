...
export default function AuthSignInScreen({ navigation }) {
    ...
    const handleSignIn = async () => {
        ...
        try {
            ...
            // AuthGate in App.js will handle navigation upon successful login
        } catch (err) {
            console.error(err);
            if (err.code === 'auth/invalid-credential' || err.code === 'auth/user-not-found' || err.code === 'auth/wrong-password') {
                ...
                setError('लॉगिन करने में समस्या आई। कृपया फिर से कोशिश करें');
            }
        } finally {
            setLoading(false);
        }
                ...
                >
                    <View style={styles.headerContainer}>
                        <View style={styles.iconContainer}>
                            <MaterialCommunityIcons name="face-woman-profile" size={64} color={COLORS.primary[600]} />
                        </View>
                        <Text style={styles.appName}>सखी</Text>
                        <Text style={styles.tagline}>आपकी डिजिटल सहेली</Text>
                    </View>

                    <View style={styles.formContainer}>
                        <Text style={styles.title}>स्वागत है</Text>
                        <Text style={styles.subtitle}>लॉगिन करने के लिए अपनी जानकारी भरें</Text>
                        ...
                        <View style={styles.footer}>
                            <Text style={styles.footerText}>खाता नहीं है?</Text>
                            <Pressable onPress={() => navigation.navigate('SignUp')}>
                                <Text style={styles.footerLink}>नया खाता बनाएं</Text>
                            </Pressable>
                        </View>
                    </View>
                </ScrollView>
